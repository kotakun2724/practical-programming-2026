...
1. CryptoHack のアカウント作成
    - アカウントを作成したら，slack の DM で海賀宛に各アカウントのユーザー ID を送信してください．[演習課題の提出について](./04-practice.mdx) を参照．
2. https://cryptohack.org/challenges/introduction/ の Finding Flags．
3. Welcome https://alpacahack.com/challenges/welcome
...
1. CryptoHack のアカウント作成
    ...
    仮に $n$ がわからなくてもアルファベットは高々26個しか存在しないため，$n$ が1 ~ 26 の全ての場合を試す総当たり攻撃を行えばよいです．
